        ...
        <div className="px-8 lg:px-16 pb-24">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                className="group relative overflow-hidden bg-gradient-to-r from-red-600 via-red-500 to-pink-600 text-white font-bold px-5 py-2.5 rounded-full text-base transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-500/30 min-w-[120px] flex items-center justify-center gap-2"
              ...
              <button
                className="group bg-white/20 backdrop-blur-md border-2 border-white/40 text-white font-bold px-5 py-2.5 rounded-full text-base transition-all duration-300 hover:bg-white/30 hover:border-white/60 hover:scale-105 hover:shadow-md min-w-[120px] flex items-center justify-center gap-2"
                style={{ borderRadius: "9999px" }}
              >
                <svg
                  className="w-4 h-4"
